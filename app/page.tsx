          ...
          <CardContent>
            ...
            <div className="flex w-full justify-between">
              <div className="flex items-center space-x-2 pt-4">
                ...
                <label
                  htmlFor="stay-logged"
                  className="text-sm text-gray-700 cursor-pointer font-16"
                >
              ...
              <div className="mr-7">
                <Link href="/phone-login ">
                  <button className="mt-4 text-black hover:text-emerald-600 underline decoration-emerald-600 underline-offset-4 cursor-pointer hover:text-emerald-700 text-sm flex items-center gap-1 font-16">
