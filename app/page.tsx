  ...
  return (
    <div className="min-h-screen bg-[#fcf5eb]">
      ...
      <div className="flex flex-col items-center px-6 pb-6 space-y-6">
        ...
        {/* Login Steps & QR Code */}
        <Card className="border border-black shadow-sm w-full max-w-3xl py-10 px-5">
          <CardContent>
            <div className="grid grid-cols-12 gap-6 items-start">
              {/* Left: Steps */}
              <div className="space-y-4 col-span-8">
                {/* Step 1 */}
                <div className="text-3xl font-normal ">Steps to log in</div>
                <div className="flex items-start gap-4">
                  <div className="w-6 h-6 rounded-full  border border-black flex items-center justify-center text-sm font-medium text-black ">
                    1
                  </div>
                  <div className="flex items-center gap-2">
                    <span className="text-black">Open WhatsApp</span>
                    ...
                    <span className="text-black">on your phone</span>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div className="flex items-center gap-2 flex-wrap">
                    <span className="text-black">On Android tap Menu</span>
                    <span
                    ...
                    <span className="text-black">· On iPhone tap Settings</span>
                    <span
                      className="bg-[#f7f8fa] rounded"
                      style={{ border: "0.5px solid #d1d7db" }}
                    >
            ...
            <div className="flex w-full justify-between">
                  ...
                  <Tooltip.Root>
                    <Tooltip.Trigger asChild>
                      <span className="inline-block cursor-pointer">
                        <Info className="w-4 h-4 text-[#111b21]" />
                      </span>
                    </Tooltip.Trigger>
                    <Tooltip.Portal>
                      <Tooltip.Content
                        side="bottom"
                        className="bg-white text-black text-sm rounded px-2 py-2 z-50 shadow-md max-w-[200px] break-words"
                      >
              ...
              <div className="">
                <Link href="/phone-login ">
                  <button className="mt-4 text-black hover:text-emerald-600 underline decoration-emerald-600 underline-offset-4 cursor-pointer hover:text-emerald-700 text-sm flex items-center gap-1 ">
