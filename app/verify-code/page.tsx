  ...
  return (
    <div className="min-h-screen  bg-[#fcf5eb]">
      ...
      <div className="flex flex-col items-center px-6 pb-6 space-y-6">
        ...
        <Card className="w-full max-w-3xl border border-black shadow-sm py-8">
          <CardHeader className="pb-4">
            ...
            <p className="text-sm text-black mt-2">
              ...
              <span className="font-medium">+1 (332) 207-6524</span>{" "}
              <button className="text-emerald-600 font-bold hover:text-emerald-700 text-sm">
                (edit)
              </button>
            </p>
          </CardHeader>
          <CardContent className="space-y-6">
            ...
            <div className="flex  pt-4">
              <button className="font-16 text-black hover:text-emerald-700 underline decoration-emerald-600 underline-offset-4 cursor-pointer inline-flex items-center gap-1">
                Log in with QR code
