  ...
  return (
    <div className="min-h-screen  bg-[#fcf5eb]">
      ...
      <div className="flex flex-col items-center px-6 pb-6 space-y-6">
        ...
        <Card className="w-full max-w-3xl border border-black shadow-sm py-10 px-[18px]">
          <div className="pl-6">
            <div className="text-3xl font-normal  mb-0 pb-0">
              Enter code on phone
            </div>
            <p className="text-sm text-black font-16">
              Linking WhatsApp account{" "}
              <span className="font-bold font-18">+1 (332) 207-6524</span>{" "}
              <Link
                href="/phone-login"
          ...
          <CardContent className="space-y-6">
              ...
              <div className="flex gap-2 items-center ">
                ...
                <div className="flex gap-1">
                  {["K", "F", "C", "J"].map((letter, index) => (
                    <div
                      key={index}
                      className="w-10 h-12 border border-gray-300 rounded-lg flex items-center justify-center text-lg font-medium bg-white text-[#3b4a54]"
                    >
                      {letter}
                    </div>
                  ))}
            ...
            <div className="space-y-4 pt-4">
              ...
              <div className="flex items-start gap-4">
                ...
                <span className="text-black">Scan the QR code to confirm</span>
              </div>
            </div>
